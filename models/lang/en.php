...
$lang = array_merge($lang,array(
		"ACCOUNT_SPECIFY_USERNAME" 				=> "Please enter your name",
		...
		"ACCOUNT_INVALID_USERNAME"				=> "Invalid name",
		"ACCOUNT_INVALID_PERSONAL_NUMBER"	=> "Invalid personal number",
		...
		"ACCOUNT_NAME_CHAR_LIMIT"					=> "Your name must be no fewer than %m1% characters or greater than %m2%",
		"ACCOUNT_SURENAME_CHAR_LIMIT"			=> "Your surename must be no fewer than %m1% characters or greater than %m2%",
		...
		"ACCOUNT_USERNAME_IN_USE"					=> "Name %m1% is already in use",
		"ACCOUNT_EMAIL_IN_USE"						=> "Email %m1% is already in use",
		"ACCOUNT_PERSNR_IN_USE"						=> "Another user is already registered with this personal number",
...
$lang = array_merge($lang,array(
		...
		"ADD_USER_TO_GROUP_ERROR"					=> "Could not add user to group",
));
?>